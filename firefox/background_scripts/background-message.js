...
const banner = `
   _                                          __ _     _
  \/_\\  _ __   ___ _ __ ___   ___  _ __   ___ \/ _(_)___| |__
 \/\/_\\\\| '_ \\ \/ _ \\ '_ \` _ \\ \/ _ \\| '_ \\ \/ _ \\ |_| \/ __| '_ \\
\/  _  \\ | | |  __\/ | | | | | (_) | | | |  __\/  _| \\__ \\ | | |
\\_\/ \\_\/_| |_|\\___|_| |_| |_|\\___\/|_| |_|\\___|_| |_|___\/_| |_|

Anemonefish（小丑鱼），代理服务器（浏览器插件）
https://github.com/CarefreeTech/anemonefish-extension/
...
// 缓存port
function cachePort(port, tab) {
    for (let p of ports[port.name]) {
        if (p.tab === tab) {
            p.port = port;
            return;
        }
